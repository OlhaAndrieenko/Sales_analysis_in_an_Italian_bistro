...
Проект містить файл Sales analysis in an Italian bistro.ipynb, в якому виконано аналіз даних, файл Dashboard.png, в якому представлена візуалізація виконаного аналізу даних за допомогою Tableau. 
